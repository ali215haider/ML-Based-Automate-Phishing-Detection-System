...
def extract_email_features(email_content):
    """
    Extract features from email content for analysis
    """
    features = {}
    ...
    try:
        ...
        common_errors = ['recieve', 'seperate', 'teh', 'wont', 'cant', 'didnt']
